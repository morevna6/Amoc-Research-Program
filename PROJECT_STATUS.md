...
* [x] Project README published
* [x] Full research roadmap published
* [x] Phase 0 directory structure established
* [x] Module 0.1 directory established
* [x] Module 0.1 index created
* [x] Project status tracking introduced
* [x] Changelog introduced
* [x] Preliminary reference register introduced
...
* detection of a current tipping point;
* identification of a confirmed collapse threshold;
* a reliable forecast of collapse timing;
* confirmation that an abrupt collapse is imminent;
* proof that observed change is entirely anthropogenic;
...
## Continuous Project Components

The following components will be developed and maintained throughout the project:
...
* a project section is completed;
* the active module changes;
* a major repository component is introduced;
* a dataset is selected or acquired;
* scientific or computational analysis begins;
* a major milestone is revised;
* project scope or limitations materially change;
* a conclusion or interpretation is formally published.

This file does not need to be updated for:

* minor wording changes;
* spelling corrections;
* formatting adjustments;
* citation-style corrections that do not alter meaning;
* routine commits with no effect on project status.
